...
const translations: Record<string, Record<Lang, string>> = {
  ...
  'review.empty': { zh: '这一天还没有留下证据。开启一次专注或记录一个瞬间吧。', en: 'No evidence yet today. Start a focus session or capture a moment.' },
  ...
  'horizon.empty': { zh: '这段时间还没有留下什么。', en: 'Nothing kept in this span yet.' },
